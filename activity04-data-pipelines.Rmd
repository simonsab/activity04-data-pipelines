...
**Response**:
The chunk with the package displayed is not contained in the knitted report when you have message = FALSE. It is present when message = TRUE
...
**Response**:
The message option is the same as the previous example.
...
run a code that returns the "min" or minimum for unemployment_rate as this metric is already calculated.
...
**Response**:
Early Childhood Education has the highest sharewomen (proportion of women in this major)
...
**Response**:
Environmental Science, communication tech, neuroscience, ecology and zoology all have median salaries below 36000 (few more not listed)
